...
export default class Game {
  ...
  async preloadImages() {
    ...
    this.cell = await this.preloadImage("./images/grass.jpg");
    this.food = await this.preloadImage("./images/appall.jpg");
  ...
  resizeCanvas() {
    this.minWidth = this.boardController.board.boadWidth * this.cell.width;
    this.minHeight = this.boardController.board.boadHeight * this.cell.height;
    if (
